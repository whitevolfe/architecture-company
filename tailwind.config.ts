  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'supporting-green': 'hsl(var(--supporting-green))', // #7E9F84 - Muted green (icons, dividers, subtle UI elements)
        'text-light': 'hsl(var(--text-light))', // White text for dark backgrounds
        'text-muted': 'hsl(var(--text-muted))', // Muted text for readability
        sidebar: {
      ...
      boxShadow: {
        ...
        gold: '0 4px 30px -5px rgba(180, 140, 50, 0.25)',
      },
    },
  },
